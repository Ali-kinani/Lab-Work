    ...
    public partial class frmArray : Form
    {
        ...
        private void BtnDisplay2DForEachLoop_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                ...
                for (int j = 1; j < 3; j++)
                {
                    lblDisplay.Text = lblDisplay.Text + " \n   " + Convert.ToString(iArray32[i - 1, j - 1]);

                }
            }
        }

        private void BtnMethodAndProparties_Click(object sender, EventArgs e)
        {
        ...
        private void BtnSomeMethodsAndProperties_Click(object sender, EventArgs e)
        {
        ...
        private void LstRandom_SelectedIndexChanged(object sender, EventArgs e)
        {
